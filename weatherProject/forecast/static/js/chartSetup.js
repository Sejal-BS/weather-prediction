document.addEventListener('DOMContentLoaded', () => {
    ...
    const ctx = chartElement.getContext('2d'); //get context of the canvas
    ...
    const forecastItems = document.querySelectorAll('.forecast-item');//collect temp and time data to display on chart
